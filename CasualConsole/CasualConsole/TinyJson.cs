...
namespace CasualConsole
{
    ...
    public static class JSONParserTiny
    {
        ...
        public static string ToJson(object obj)
        {
            ...
            {
                return objBool ? "true" : "false";
            }
            else if (obj is string objstr)
            {
                return JsonEscape(objstr);
            }
            else if (obj is DateTime objdate)
            {
                return JsonEscape(objdate.ToString("yyyy-MM-dd HH:mm:ss"));
            }
            else if (validTypes.Contains(obj.GetType()))
            {
                return obj.ToString();
            }
            ...
            else
            {
                ...
                {
                    values.Add("\"" + property.Name + "\"", ToJson(property.GetValue(obj, null)));
                }

                foreach (var field in fields)
                {
                    values.Add("\"" + field.Name + "\"", ToJson(field.GetValue(obj)));
                }
        ...
        internal static object ParseValue(Type type, string json)
        {
            ...
            {
                return DateTime.Parse(json.Replace("\"", ""));
            }
