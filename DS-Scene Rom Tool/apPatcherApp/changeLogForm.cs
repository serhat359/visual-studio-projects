namespace apPatcherApp
{
    ...
    public class changeLogForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.patchList.Columns.AddRange(new ColumnHeader[] { this.patchListHeader_name, this.patchListHeader_crc, this.patchListHeader_creator, this.patchListHeader_offsets });
        ...
        private void patchList_ColumnClick(object sender, ColumnClickEventArgs e)
        {
            ...
            else if (this.patchList.Sorting == SortOrder.Ascending)
            {
                this.patchList.Sorting = SortOrder.Descending;
            }
            else
            {
                this.patchList.Sorting = SortOrder.Ascending;
        ...
        private void showChangeLogInfo(string type)
        {
            ...
            try
            {
                ...
                {
                    string str5;
                    for (int i = 0; (str5 = reader.ReadLine()) != null; i++)
                    {
                        str3 = str3 + str5;
                    }
                    reader.Close();
        ...
        private void showCMPDatabaseInfo()
        {
            ...
            if (this.curdbitems > 0)
            {
                ...
                {
                    string str3 = this.txtInstalledDbs.Text;
                    this.txtInstalledDbs.Text = str3 + infoArray[i].fn + " v" + infoArray[i].ver + "\r\n";
                }
            }
            object text = this.txtInstalledDbs.Text;
            this.txtInstalledDbs.Text = string.Concat(new object[] { text, "\r\nCMP Database Supports ", Program.form.cmpGamesFilled, " Games" });
        }
