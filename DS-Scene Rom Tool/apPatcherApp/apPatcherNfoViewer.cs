namespace apPatcherApp
{
    ...
    public class apPatcherNfoViewer : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.menuStrip1.Items.AddRange(new ToolStripItem[] { this.fileToolStripMenuItem, this.themeToolStripMenuItem });
            this.menuStrip1.Location = new Point(0, 0);
            this.menuStrip1.Name = "menuStrip1";
            this.menuStrip1.Size = new Size(0x28b, 0x18);
            this.menuStrip1.TabIndex = 2;
            this.menuStrip1.Text = "menuStrip1";
            this.fileToolStripMenuItem.DropDownItems.AddRange(new ToolStripItem[] { this.openNFOToolStripMenuItem, this.exitToolStripMenuItem });
            ...
            this.themeToolStripMenuItem.DropDownItems.AddRange(new ToolStripItem[] { this.themeToolStripMenuItem1, this.themeToolStripMenuItem2, this.themeToolStripMenuItem3, this.themeToolStripMenuItem4, this.themeToolStripMenuItem5, this.toolStripSeparator1, this.fontSizeToolStripMenuItem });
            ...
            this.fontSizeToolStripMenuItem.DropDownItems.AddRange(new ToolStripItem[] { this.pxToolStripMenuItem7, this.pxToolStripMenuItem8, this.pxToolStripMenuItem9, this.pxToolStripMenuItem10 });
